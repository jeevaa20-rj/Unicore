        ...
        <div className="col-12 col-md-6 d-none d-md-flex flex-column justify-content-between p-5 text-white" 
          ...
          <div>
            <div className="d-flex align-items-center gap-2 mb-1">
              <div className="bg-white rounded p-1 text-center fw-bold d-flex align-items-center justify-content-center" style={{ width: '35px', height: '35px' }}>
                <i className="bi bi-mortarboard-fill fs-5" style={{ color: '#5c2d53' }}></i>
              </div>
          ...
          <div className="my-auto py-5" style={{ maxWidth: '450px' }}>
            <h1 className="fw-bold mb-3 display-6">Empowering Academic Excellence</h1>
            <p className="text-white-50">Join the central hub for Uva Wellassa University students. Collaborative learning, resource management, and campus insights all in one place.</p>
            <div className="d-flex gap-4 text-white-50 mt-4">
              <span className="small d-flex align-items-center gap-2"><i className="bi bi-people-fill text-warning"></i> PEER LEARNING</span>
              <span className="small d-flex align-items-center gap-2"><i className="bi bi-book-half text-info"></i> COURSE HUB</span>
            </div>
          </div>
          ...
          <div className="w-100" style={{ maxWidth: '420px' }}>
            <div className="text-center text-md-start mb-4">
              <div className="d-flex align-items-center gap-2 mb-3 justify-content-center justify-content-md-start">
                <div className="p-1 rounded text-white d-flex align-items-center justify-content-center" style={{ backgroundColor: '#5c2d53', width: '32px', height: '32px' }}>
                  <i className="bi bi-layers-half small"></i>
                </div>
                <h6 className="m-0 fw-bold text-uppercase tracking-wider" style={{ color: '#5c2d53', fontSize: '0.85rem' }}>UniCore <span className="text-muted fw-normal">UWU Dashboard</span></h6>
              </div>
            ...
            <form onSubmit={handleSubmit} className="d-flex flex-column gap-3">
              <div>
                <label className="form-label text-muted fw-bold small text-uppercase" style={{ fontSize: '0.65rem' }}>Email Address</label>
                <div className="input-group">
                  <span className="input-group-text bg-light border-0 text-muted"><i className="bi bi-envelope"></i></span>
                  <input type="email" className="form-control bg-light border-0 py-2.5 small" name="email" placeholder="alex@uwu.ac.lk" value={credentials.email} onChange={handleChange} required style={{ borderRadius: '0 8px 8px 0' }} />
                </div>
              </div>
              <div>
                ...
                <div className="input-group">
                  ...
                  <input type="password" className="form-control bg-light border-0 py-2.5 small" name="password" placeholder="••••••••" value={credentials.password} onChange={handleChange} required style={{ borderRadius: '0 8px 8px 0' }} />
                </div>
              </div>
              <div className="d-flex justify-content-between align-items-center my-1" style={{ fontSize: '0.8rem' }}>
