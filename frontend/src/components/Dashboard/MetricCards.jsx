      ...
      <div className="col-12 col-md-4 col-xl-3">
        ...
        >
          <div className="d-flex justify-content-between align-items-start mb-2">
            <span className="p-2 bg-light rounded text-purple">
      ...
      <div className="col-12 col-md-4 col-xl-3">
        ...
        >
          ...
          <div className="d-flex gap-1 mt-3">
            <div
              className="bg-dark rounded-pill flex-grow-1"
              style={{ height: "5px" }}
            ></div>
            <div
              className="bg-dark rounded-pill flex-grow-1"
            ...
            ></div>
            <div
              className="bg-secondary opacity-25 rounded-pill flex-grow-1"
              style={{ height: "5px" }}
            ></div>
          </div>
        </div>
      ...
      <div className="col-12 col-md-4 col-xl-6">
        ...
        >
          <div className="d-flex justify-content-between align-items-center mb-2">
            ...
            <select
              className="form-select form-select-sm border-0 bg-light w-auto py-0 px-2"
          ...
          {/* Simulated Bars */}
          <div
            className="d-flex align-items-end justify-content-between flex-grow-1 pt-2"
            style={{ minHeight: "55px" }}
          >
            <div
              className="bg-light-subtle rounded-top bg-secondary bg-opacity-25"
              style={{ height: "30%", width: "11%" }}
            ></div>
            <div
              className="bg-light-subtle rounded-top bg-secondary bg-opacity-25"
              style={{ height: "55%", width: "11%" }}
            ></div>
            <div
              className="bg-light-subtle rounded-top bg-secondary bg-opacity-25"
            ...
            <div
              className="bg-light-subtle rounded-top bg-secondary bg-opacity-25"
              style={{ height: "85%", width: "11%" }}
            ></div>
            <div
              className="bg-light-subtle rounded-top bg-secondary bg-opacity-25"
              style={{ height: "35%", width: "11%" }}
            ></div>
            <div
              className="bg-light-subtle rounded-top bg-secondary bg-opacity-25"
              style={{ height: "75%", width: "11%" }}
            ></div>
            <div
