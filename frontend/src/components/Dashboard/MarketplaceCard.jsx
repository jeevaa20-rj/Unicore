    ...
    <div className="col-12 col-sm-6 col-md-4 col-xl-3">
      ...
      >
        <div className="position-relative" style={{ height: "150px" }}>
          ...
          />
          <span
            className="position-absolute top-0 start-0 m-2 badge fw-semibold"
            style={{
              fontSize: "0.7rem",
        ...
        <div className="card-body d-flex flex-column justify-content-between p-3">
          <div className="mb-3">
            ...
            <p
              className="text-muted m-0 text-truncate"
          ...
          <div className="d-flex align-items-center justify-content-between pt-2 border-top border-light">
            <div className="d-flex align-items-center gap-2">
              <div
                className="bg-secondary rounded-circle text-white text-center fw-bold"
                style={{
                  width: "28px",
                  height: "28px",
                  fontSize: "0.7rem",
            ...
            <button
              className="btn btn-light bg-secondary bg-opacity-10 border-0 p-0 rounded d-flex align-items-center justify-content-center"
              style={{ width: "28px", height: "28px" }}
            >
              <i
                className="bi bi-chat-left-text-fill text-secondary"
                style={{ fontSize: "0.75rem" }}
              ></i>
            </button>
          </div>
